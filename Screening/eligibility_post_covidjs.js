...
// Safe splits
var splitted_meds = safeSplit("'{meds01_2}'");
var splitted_diag = safeSplit("'{gmh_diagnosis02_2}'");
var splitted_thinner = safeSplit("'{bloodthinners_reason_3}'");
var splitted_antipsy = safeSplit("'{Antipsychotics_name_2}'");

// -----------------
// calccageaid
var cage = {calccageaid_1};
...
if (splitted_diag.length > 0) {
    ...
    if (splitted_diag.indexOf("8") > -1) ineligible = 1; // neurological
    if (splitted_diag.indexOf("9") > -1) ineligible = 1; // psychological
    ...
    if (splitted_diag.indexOf("17") > -1) {
        var ab = {astma_bronchitis_2};
        var ab3 = {astma_bronchitis_3};
        if (ab !== 'NA') {
            if (ab == 1) {
                ineligible = 1;
            } else if (ab == 0 && ab3 !== 'NA') {
                if (ab3 == 1) eligible = 1;
                else if (ab3 == 0) eligible_fu = 1;
            }
        }
    }
